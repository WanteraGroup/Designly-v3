   ...
   <div className='grid gap-5 lg:grid-cols-[260px_1fr]'>
    ...
    <main>
      <div className='mb-5 rounded-2xl border border-emerald-500/30 bg-emerald-500/10 p-3 text-xs text-emerald-200'>
       <span className='font-semibold'>TESZT MÓD AKTÍV</span> · A kreditlevonás ideiglenesen ki van kapcsolva, így a DESIGNLY funkciói szabadon tesztelhetők.
      </div>
     ...
     {tool==='cnc' && <CncPromptStudio />}
     {tool==='planner' && <EngineeringPlanner />}
     {tool==='product' && <section className='space-y-4'>
      ...
      <div className='grid gap-3 sm:grid-cols-3'>
       <label className='text-xs text-ink-400'>Felbontás<select className='vp-input mt-1' value={editResolution} onChange={e=>setEditResolution(e.target.value as '1k'|'2k'|'4k')}><option value='1k'>1K · INGYENES TESZT</option><option value='2k'>2K · INGYENES TESZT</option><option value='4k'>4K · INGYENES TESZT</option></select></label>

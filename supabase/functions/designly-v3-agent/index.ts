...
function doc(d:any,lang:string,brief:string){
  ...
  return {
    site:{title:s(d.siteTitle,"DESIGNLY",120),language:lang,theme:{mode:d.themeMode==="light"?"light":"dark",palette:x(d.palette,["#c9a45c"],8).map((v:any)=>s(v,"#c9a45c",60)),heading_font:s(d.headingFont,"Marcellus",80),body_font:s(d.bodyFont,"Inter",80)},nav:x(d.nav,[],8).map((v:any)=>({label:s(v?.label,"Link",80),href:s(v?.href,"#",160)}))},
    blocks
  };
}

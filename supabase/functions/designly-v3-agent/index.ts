...
async function generateQwenBackground(prompt:string):Promise<string>{
  ...
  const start=await fetch(base+"/gradio_api/call/text_to_image",{
    method:"POST",
